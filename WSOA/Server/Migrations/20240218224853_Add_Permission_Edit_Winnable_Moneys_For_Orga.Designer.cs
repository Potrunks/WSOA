...
namespace WSOA.Server.Migrations
{
    ...
    [Migration("20240218224853_Add_Permission_Edit_Winnable_Moneys_For_Orga")]
    partial class Add_Permission_Edit_Winnable_Moneys_For_Orga
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WSOA.Shared.Entity.BusinessAction", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Code = "EDIT_PLAYABLE_TOURNAMENT",
                            Label = "Editer un tournoi jouable"
                        },
                        new
                        {
                            Code = "COMMON_DASHBOARD",
            ...
            modelBuilder.Entity("WSOA.Shared.Entity.BusinessActionByProfileCode", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 8,
                            BusinessActionCode = "EDIT_PLAYABLE_TOURNAMENT",
                            ProfileCode = "ORGA"
                        },
                        new
                        {
                            Id = 9,
                            BusinessActionCode = "COMMON_DASHBOARD",
                            ProfileCode = "ORGA"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("WSOA.Shared.Entity.JackpotDistribution", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("JackpotDistributions");
                });
            ...
            modelBuilder.Entity("WSOA.Shared.Entity.JackpotDistribution", b =>
                {
                    b.HasOne("WSOA.Shared.Entity.Tournament", "Tournament")
                        .WithMany()
